...
session_start();
  ...
  if (isset($_POST['submit'])) { 
    ...
    mysqli_query($conn, "INSERT INTO `bookingdetails` (`bookingdetails`, `checkIndate`, `checkOutdate`, 
    `numGuest`, `amount`, `paymentMade`, `hostConfirmation`, `UserCancel`, `rejectReason`, 
    `accommodationId`, `userId`) 
    VALUES (NULL, '$start_date', '$end_date', '$num_guest', '$total_price', '', 
    '', '', '', '$aid', '$uid')");
