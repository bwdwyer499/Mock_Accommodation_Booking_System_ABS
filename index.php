<?php
  ...
  //get accommodation details
  $select_accommodation = "SELECT * FROM `accomodationdetails` ORDER BY `accomodationdetails`.`rateHouse` DESC LIMIT 2";
      ...
      <div class="d-flex justify-content-between collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
          ...
          <?php if($_SESSION["userType"] == "manager"): ?>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="host_house.php">Dashboard</a>
            </li>
          <?php elseif($_SESSION["userType"] == "host"): ?>
            <li class="nav-item">
